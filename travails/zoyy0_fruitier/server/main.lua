...
RegisterServerEvent('esx_fruitier:GiveItem')
AddEventHandler('esx_fruitier:GiveItem', function()
	...
	if Quantity >= 20 then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Vous avez récupérer ~g~x' .. amount .. ' Orange')
	end
...
RegisterServerEvent('esx_fruitier:startVente')
AddEventHandler('esx_fruitier:startVente', function()
...
RegisterServerEvent('esx_fruitier:stopVente')
AddEventHandler('esx_fruitier:stopVente', function()
